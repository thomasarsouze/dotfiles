return {
  {
    -- Taken from https://github.com/Vigemus/iron.nvim
    -- With some custom modifications from https://github.com/g0t4/iron.nvim
    -- Thanks to this video: https://www.youtube.com/watch?v=eIp31pLQ4sI
    --
    --
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>i", NOOP, { desc = "iron" })
      vim.keymap.set("n", "<leader>ic", NOOP, { desc = "iron clear => send" })
      vim.keymap.set("n", "<leader>is", NOOP, { desc = "iron send" })
      vim.keymap.set("n", "<leader>im", NOOP, { desc = "iron mark" })
      ...
      end, { desc = "iron, move next cell [j]" })
      ...
      end, { desc = "iron, move previous cell [k]" })
      ...
      end, { desc = "iron, [i]nsert [b]lock divider" })
      ...
      core.setup({
        config = {
          ...
          repl_definition = {
            ...
            r = {
              command = { "r" }, -- actually, an alias to Radian
            },
            python = {
